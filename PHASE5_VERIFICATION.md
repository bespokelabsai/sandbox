...
| Complete offline suite | 268 passed, 81 skipped, 2 subtests passed |
| Database compatibility | Fresh schema v6 and legacy in-place migration/reopen passed |
...
| Full release pipeline | Formatter, Ruff, compile, 268-test suite, schema v6 migration, sdist/wheel build/install, and browser smoke above |
